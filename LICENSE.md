...
ansiwise-api is licensed under the **PolyForm Noncommercial License 1.0.0**, reproduced in full
below. The licensor is Simetrix GmbH.

    Required Notice: Copyright Simetrix GmbH (https://github.com/simetrixch)

**Noncommercial use is free, and needs no permission from anybody.** Personal study, hobby projects,
research, experiment and testing are covered, and so is use by a charity, an educational institution,
a public research organization, a public safety or health organization, an environmental protection
organization or a government institution — whatever their funding.

**Commercial use needs a separate license from Simetrix GmbH.** If you are a company, or your use has
an anticipated commercial application, the terms below do not cover you. Open an issue in this
repository titled `Commercial licence` and Simetrix GmbH will answer with terms.

**Contributions are welcome.** See `CONTRIBUTING.md` for what happens to a contribution's copyright,
which is a question to settle before you write the code rather than after.
...
To obtain a license under these terms, you must agree to them as both strict obligations and
