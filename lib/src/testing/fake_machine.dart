...
/// aspirational: a step reaches outside only through the four ports, so replacing them replaces the
...
/// A machine made of the four fakes, ready to hand to a runner.
Machine fakeMachine({FakeShell? shell, FakeFiles? files, FakeHttp? http, FakeClock? clock}) =>
    Machine(
