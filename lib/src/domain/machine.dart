...
///
/// Five ports and nothing else. Everything a program does to a machine goes through one of them,
...
final class Machine {
  ...
  ///
  /// A port like the others although it reaches no machine: what it produces has to be the same on
  /// no two installations, and that is exactly the property a test cannot assert against a real
  /// generator. It is here rather than beside the steps that mint, because every one of them would
  /// otherwise carry its own.
