...
/// notes have nothing to list: the page would carry a compare link and no line about what changed,
/// which is the empty page the release notes are supposed to replace. A merge commit is no test of
/// that either way, since a squashed pull request leaves none. Unique tags per release did not change that: the tag
