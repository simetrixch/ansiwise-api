...
```
bash tools/ci.sh          # the gate: a pinned container, six checks and the full test suite
```
...
See [LICENSE.md](LICENSE.md) for the terms and [CONTRIBUTING.md](CONTRIBUTING.md) before opening a
pull request.
